...
import { UserDB, DBUser, TransactionalUserDBImpl, TypeORM, TracedWorkspaceDB, bindDbWithTracing, WorkspaceDB } from '@gitpod/gitpod-db/src';
import { ContainerModule, Container } from 'inversify';
import { UserService } from '../../../src/user/user-service';

import { SubscriptionService } from '@gitpod/gitpod-payment-endpoint/dist/accounting';
import { DBSubscription } from '@gitpod/gitpod-db/ee/src/typeorm/entity/db-subscription';
