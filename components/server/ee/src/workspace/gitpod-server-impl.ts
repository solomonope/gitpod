...
import { LicenseDB } from "@gitpod/gitpod-db/src";
...
import { AccountService, SubscriptionService, TeamSubscriptionService } from "@gitpod/gitpod-payment-endpoint/dist/accounting";
import { AccountingDB, TeamSubscriptionDB, EduEmailDomainDB } from "@gitpod/gitpod-db/ee";
import { ChargebeeProvider, UpgradeHelper } from "@gitpod/gitpod-payment-endpoint/dist/chargebee";
import { ChargebeeCouponComputer } from "../user/coupon-computer";
import { ChargebeeService } from "../user/chargebee-service";
import { Chargebee as chargebee } from '@gitpod/gitpod-payment-endpoint/dist/chargebee';
